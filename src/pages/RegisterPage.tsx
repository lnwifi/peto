    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center py-12 px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-carbon/5 w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="font-nunito font-bold text-2xl text-carbon">¡Unite al Club!</h1>
          <p className="text-carbon/60 text-sm mt-2">Creá tu cuenta y empezá a ayudar</p>
        </div>
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-white px-4 text-carbon/40">o registrarte con</span>
            </div>
          </div>
        ...
        <p className="text-center text-carbon/40 text-xs mt-4">
